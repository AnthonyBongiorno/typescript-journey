...
// Declare a variable "anyType" of type "any". The "any" type in TypeScript means that this variable can hold any type of value. Assign it the string "dasdsadsa".
let anyType: any = "dasdsadsa";
